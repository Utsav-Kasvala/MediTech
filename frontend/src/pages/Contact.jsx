//remember jyre meditech ma commit kar tyre index.css bhi karje ema changes che
const Contact = () => {
  return (
    <section>
      <div className="px-4 mx-auto max-w-screen-md">
        ...
        <p className='mb-8 lg:mb-16 font-light text-center text_para'>
          Got a techinal issue??😞 Want to send feedback about a beta feature?? Let us know, We'll Solve it😃
        </p>
