  ...
  return (
    <section className='px-5 xl:px-0'>
      <div className="max-w-[1050px] mx-auto">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center gap-3">
               {selectedFile && <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-black flex items-center justify-center'>
        ...
        <p className="mt-5 text-textColor text-center">Already have an Account? 👉<Link to='/login' className="text-primaryColor font-medium ml-1 border border-solid border-primaryColor rounded-md px-1 py-1"> Login</Link></p>
            </form>
          </div>
        </div>
      </div>
