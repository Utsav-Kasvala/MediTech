...
import heroImg01 from '../assets/images/doc1.png'
import heroImg02 from '../assets/images/doc2.png'
import heroImg03 from '../assets/images/doc3.png'
            ...
            <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
              ...
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-[6px] lg:gap-3'>
                  <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor font-[600]'>Tuesday</p>
        ...
        <div className="flex justify-between gap-[50px] lg:gap-0">
          ...
          <div className='w-full md:w-1/2'>
            <h2 className='heading'>
              Most of our beloved patients Questions are as Follows:
            </h2>
            <FaqList />
          </div>
        </div>
